...
const Schema: z.ZodType<Prisma.QuestionSetUpdateManyWithoutQuestionnaireNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const QuestionSetUpdateManyWithoutQuestionnaireNestedInputObjectSchema =
  Schema;
