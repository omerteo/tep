...
const Schema: z.ZodType<Prisma.QuestionScoreCreateNestedManyWithoutQuestionSetInput> =
  z
    .object({
      create: z
        .union([
...
export const QuestionScoreCreateNestedManyWithoutQuestionSetInputObjectSchema =
  Schema;
