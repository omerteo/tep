...
const Schema: z.ZodType<Prisma.QuestionScoreUncheckedUpdateManyWithoutQuestionSetNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const QuestionScoreUncheckedUpdateManyWithoutQuestionSetNestedInputObjectSchema =
  Schema;
