...
const Schema: z.ZodType<Prisma.QuestionSetUncheckedCreateNestedManyWithoutQuestionnaireInput> =
  z
    .object({
      create: z
        .union([
...
export const QuestionSetUncheckedCreateNestedManyWithoutQuestionnaireInputObjectSchema =
  Schema;
